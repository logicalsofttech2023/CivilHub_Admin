...
const Subcetagory = () => {
  ...
  const [subcetegory_name, setsubcetegory_name] = useState();
  ...
  const subcategorydatahandle = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/admin_add_subcategoy`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getbannerlist = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/admin_all_category`,options)
      .then((res) => {
  ...
  let getsubcategory = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/admin_all_sub_cate`,options)
      .then((res) => {
    ...
    swal({
      ...
      if (willDelete) {
        let deletebannerimage = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}admin/api/admin_delete_subcate`,
              bannerdata,
              options
            )
            .then((res) => {
                          ...
                          <div className="w-100">
                            ...
                            <div className="form-group  lang_form" id="en-form">
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  setsubcetegory_name(e.target.value);
                                }}
                                type="text"
                                name="name[]"
                                className="form-control"
