...
const Cetagory = () => {
  ...
  const categorydatahandle = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/admin_add_category`,
        cetegory,
        options
      )
      .then((res) => {
  ...
  let getbannerlist = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/admin_all_category`,
        options
      )
      .then((res) => {
    ...
    swal({
      ...
      if (willDelete) {
        let deletebannerimage = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}admin/api/admin_delete_category`,
              bannerdata,
              options
            )
            .then((res) => {
