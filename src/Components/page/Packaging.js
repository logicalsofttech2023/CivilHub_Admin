    ...
    return (
      <tr>
        ...
        <td>
          ...
          {/* {data?.products[0]?.payment_status == "Paid" ? <span className="badge badge-soft-success">{data?.products[0]?.payment_status}</span> : <span className="badge badge-soft-danger">{data?.products[0]?.payment_status}</span>} */}
        </td>
        <td className="text-capitalize ">
          <label className="badge badge-soft-primary">Packing</label>
        </td>
